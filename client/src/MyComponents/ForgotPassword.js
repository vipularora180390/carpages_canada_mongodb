...
export default function ForgotPassword() {
   ...
   useEffect(()=>{
    ...
    const getRecord=()=>
    {
      ...
      {
        Axios.post("https://carpages-canada-mongodb-jnh0.onrender.com/users/forgotCredentials", 
   ...
   console.log("showSection"+showSection);
     ...
     const  onSignSubmit_2=async (e) =>
    {
     ...
     Axios.post("https://carpages-canada-mongodb-jnh0.onrender.com/users/otpEmail",{email:email,otp:OTP12,fullName:fullName}).then((res)=>{
        console.log(res.data);
...
{if(re_password === password)
  {
    Axios.post("https://carpages-canada-mongodb-jnh0.onrender.com/users/updatePassword",{userId:userId,user_pass:re_password}).then((res)=>{
      console.log(res.data);
