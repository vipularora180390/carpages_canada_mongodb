...
export default function SearchResults() {
  ...
  Item = JSON.parse(localStorage.getItem('dataItems'));
     if(Item != null)
    {
  Axios.get("https://carpages-canada-mongodb-jnh0.onrender.com/users/isUserAuthenticated",{headers:{"x-access-token":Item["token"]},}).then((res)=>{
    ...
    if(!vehicleClass && !makeName && !city && !MyState )
    {
        ...
        Axios.get("https://carpages-canada-mongodb-jnh0.onrender.com/listings/get_allListings").then((res)=>{
     ...
     else if(MyState)
     {
      console.log(MyState.showresult+"image.png"+MyState);
          if(MyState.showresult)
          {
           ...
           Axios.post("https://carpages-canada-mongodb-jnh0.onrender.com/listings/search_bar",{keyword:MyState.showresult,location:keywordLocation?keywordLocation["SearchBarLocation"]:""}).then((res)=>{
              console.log(res.data);
              setfetchListings(res.data);
              });
          }
            ...
            Axios.get("https://carpages-canada-mongodb-jnh0.onrender.com/categories/getprices").then((res2)=>{
            //  console.log(res2.data);
              setvehicleprice(res2.data);
            });
            Axios.get("https://carpages-canada-mongodb-jnh0.onrender.com/categories/years").then((res3)=>{
         //     console.log(res3.data);
              setvehicleyears(res3.data);
            });
            Axios.get("https://carpages-canada-mongodb-jnh0.onrender.com/categories/onlycities").then((res1)=>{
  ...
  useEffect(()=>{
    ...
    { 
      if(type=="private")
      {
        Axios.post("https://carpages-canada-mongodb-jnh0.onrender.com/listings/FilterByListingSellertype",{ListingSellertype:"private"}).then((res22)=>{
      ...
      {
        Axios.post("https://carpages-canada-mongodb-jnh0.onrender.com/listings/FilterByListingSellertype",{ListingSellertype:"dealer"}).then((res22)=>{
          console.log(res22.data);
        setfetchListings(res22.data);
         });
      }
      ...
      {
        Axios.post("https://carpages-canada-mongodb-jnh0.onrender.com/listings/FilterByListingSellertype",{ListingSellertype:"sold"}).then((res22)=>{
          console.log(res22.data);
        setfetchListings(res22.data);
         });
      }
    ...
    if(city)
    {
      ...
      Axios.post("https://carpages-canada-mongodb-jnh0.onrender.com/listings/FilterByCityListings",{cityname:city}).then((res11)=>{
    ...
    console.log("hanji kidan");
      Axios.post("https://carpages-canada-mongodb-jnh0.onrender.com/listings/FilterByClassListings",{vehicleClass:vehicleClass}).then((res22)=>{
        console.log(res22.data);
      setfetchListings(res22.data);
       });
    }
    ...
    console.log("hanji makeName");
      Axios.post("https://carpages-canada-mongodb-jnh0.onrender.com/listings/FilterByMakeListings",{makename:makeName}).then((res33)=>{
    ...
    console.log("hanji MyState");
      Axios.post("https://carpages-canada-mongodb-jnh0.onrender.com/listings/Find_A_Car",MyState).then((res43)=>{
 ...
 const changeSaleStatus=(ID,status)=>
{
  ...
  if(status==="unsold")
  {
    Axios.post("https://carpages-canada-mongodb-jnh0.onrender.com/listings/updatetSaleStatus",{ListingId:ID,status:"sold"}).then ((response1) =>{
  ...
  {
    Axios.post("https://carpages-canada-mongodb-jnh0.onrender.com/listings/updatetSaleStatus",{ListingId:ID,status:"unsold"}).then ((response1) =>{
      console.log(response1.data);
...
const PushArr=(e)=>
{
  if(e.length > 0)
  {
    Axios.post("https://carpages-canada-mongodb-jnh0.onrender.com/categories/getchoosedmakes",{makesarr:e}).then((res4)=>{
  ...
  else if(AllMakes.length == fetchMakes.length)
  {
     ...
     Axios.post("https://carpages-canada-mongodb-jnh0.onrender.com/categories/getchoosedmakes",{makesarr:AllMakes}).then((res4)=>{
      console.log(res4.data);
      setfetchModels(res4.data); 
    });
  }
...
const MakesFetch=()=>
{
  Axios.get("https://carpages-canada-mongodb-jnh0.onrender.com/categories/makes").then((res)=>{
          //   console.log(res.data);
...
const handleSellerId= (e)=>
{
  ...
  Axios.post("https://carpages-canada-mongodb-jnh0.onrender.com/users/getDealerDetails",{sellerid:e}).then((res4)=>{
      console.log(res4.data);
...
const Apply=()=>
{
    ...
    if(query1)
    {
      ...
      if(a>0)
      {
        Axios.post("https://carpages-canada-mongodb-jnh0.onrender.com/listings/getFilterListings",{buyfromHome:buyfromHome,cityname:query1,bodyStyle:bodyStyle,allmodels:allModels,allmakes:AllMakes,makename:fetchMakes1,modelname:fetchModels1,minyears:minyears,maxyears:maxyears,minprice:aa,maxprice:bb,minmileage:minmileage,
 ...
 const [sortFilter,setsortFilter]=useState('');
   ...
   const SearchKeyword=(e)=>
   {
      if(e.key==="Enter")
      {
        Axios.post("https://carpages-canada-mongodb-jnh0.onrender.com/listings/search_bar",{keyword:e.target.value,location:query1}).then((res)=>{
          console.log(res.data);
          setfetchListings(res.data);
          });
      }
  ...
  const imagEupload=()=>
  {
    ...
    Axios.post("https://carpages-canada-mongodb-jnh0.onrender.com/listings/firebase_New_Images",imageData).then((res)=>{
    console.log(res);
    })
