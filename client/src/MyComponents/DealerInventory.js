...
export default function DealerInventory() {
    ...
    Axios.post("https://carpages-canada-mongodb-jnh0.onrender.com/users/getDealerDetails",{userId:Seller_ID}).then((res3)=>{
   ...
   {
    Axios.post("https://carpages-canada-mongodb-jnh0.onrender.com/listings/getDealerListings",{userId:Seller_ID}).then((res3)=>{
      console.log(res3.data);
   ...
   const GetAllMakes=()=>
   {
    Axios.post("https://carpages-canada-mongodb-jnh0.onrender.com/listings/getDealervehicleCount",{userId:Seller_ID}).then((res3)=>{
      console.log(res3.data);
   ...
   const getMakeModel=(e)=>
   {
    ...
    if(bodyStyle)
    {
      Axios.post("https://carpages-canada-mongodb-jnh0.onrender.com/listings/getDealervehicleModelCount",{userId:Seller_ID,bodyStyle:bodyStyle,make_name:e}).then((res3)=>{
        console.log(res3.data);
    ...
    {
      Axios.post("https://carpages-canada-mongodb-jnh0.onrender.com/listings/getDealervehicleModelCount",{userId:Seller_ID,make_name:e}).then((res3)=>{
        console.log(res3.data);
        setfetch_Models_total(res3.data);
      });
    }
   ...
   const getBodyStyle=(e)=>
   {
    ...
    Axios.post("https://carpages-canada-mongodb-jnh0.onrender.com/listings/getDealervehicleCount",{userId:Seller_ID,body_style:e}).then((res3)=>{
        console.log(res3.data);
        setfetch_Makes_total(res3.data);
      });
   }
   ...
   const RefineSearch=()=>
   {
    ...
    {
      Axios.post("https://carpages-canada-mongodb-jnh0.onrender.com/listings/getDealerRefineInventory",{Seller_ID:Seller_ID,bodyStyle:bodyStyle,selectedMake:selectedMake,selectedModel:selectedModel,selectedMinyear:selectedMinyear,selectedMaxyear:selectedMaxyear}).then((res3)=>{
        console.log(res3.data);
        setfetchListings(res3.data);
      });
    }
