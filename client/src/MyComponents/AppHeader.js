...
const SignOut =()=>{
  ...
  setLogIn(false);
  Axios.post("https://carpages-canada-mongodb-jnh0.onrender.com/users/Logout",{pathname: pathname}).then((res1)=>{
...
const SignOut_team =()=>{
  ...
  myStore.dispatch(RESET_ACTION);
  setLogIn(false);
  Axios.post("https://carpages-canada-mongodb-jnh0.onrender.com/Logout").then((res1)=>{
