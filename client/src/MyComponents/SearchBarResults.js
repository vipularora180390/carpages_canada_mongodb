   ...
   { 
    ...
    {  
        keywordLocation = JSON.parse(localStorage.getItem('User_Choice_Location'));
            Axios.post("https://carpages-canada-mongodb-jnh0.onrender.com/listings/search_bar",{keyword:MyState.keyWord,location:keywordLocation["SearchBarLocation"]}).then((res)=>{
            console.log(res.data);
            setlistingsResults(res.data);
            });
             Axios.post("https://carpages-canada-mongodb-jnh0.onrender.com/users/search_bar",{keyword:MyState.keyWord,location:keywordLocation["SearchBarLocation"]}).then((res)=>{
             console.log(res.data);
