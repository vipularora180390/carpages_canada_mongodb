...
export default function MainVehicleSearch() {
  ...
  useEffect(() => {
    ...
    Axios.get("https://carpages-canada-mongodb-jnh0.onrender.com/categories/getprices").then((res)=>{
      setprice(res.data);
      console.log(res.data);
      })
      Axios.get("https://carpages-canada-mongodb-jnh0.onrender.com/categories/makes").then((res1)=>{
        setmakes(res1.data);
        console.log(res1.data);
      })
        Axios.get("https://carpages-canada-mongodb-jnh0.onrender.com/categories/popularcities").then((res2)=>{
  ...
  const showcities=()=>{
    Axios.get("https://carpages-canada-mongodb-jnh0.onrender.com/categories/onlycities").then((res2)=>{
      setCities(res2.data);
      console.log(res2.data);
  })
  };
