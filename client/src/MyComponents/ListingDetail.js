...
export default function ListingDetail() {
    ...
    console.log(Listing_ID+"Data.."+seller_id);
     ...
     useEffect(()=>{
           ...
           Axios.post("https://carpages-canada-mongodb-jnh0.onrender.com/listings/getmoreListings",{userId:Seller_ID,ListingId:Listing_ID}).then((res2)=>{
    ...
    Axios.get("https://carpages-canada-mongodb-jnh0.onrender.com/users/isUserAuthenticated",{headers:{"x-access-token":Item["token"]},}).then((res)=>{
       ...
       console.log(res.data.auth);
        if(res.data.auth)
        {
          ...
          Axios.post("https://carpages-canada-mongodb-jnh0.onrender.com/watchlist/insertWatchList",{userId:Item["userId"],listing_id:Listing_ID}).then((res)=>{
            console.log(res.data);
  ...
  const sendMessage=()=>
   {
    ...
    Axios.post("https://carpages-canada-mongodb-jnh0.onrender.com/users/sendQueryMessagePhone",{queryName:queryName,queryPhone_No:queryPhone_No,queryEmail:queryEmail,queryYear:queryYear,queryMake:queryMake,queryModel:queryModel}).then((res)=>{
      console.log(res.data);
     });
   }
