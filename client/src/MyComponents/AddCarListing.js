...
let safety,assistance,lighting,infotainment,connectivity,comfort,convenience,exterior,security="";
 ...
 useEffect(()=>{
  ...
  /*Axios.get("https://carpages-canada-mongodb-jnh0.onrender.com/listings/getListingId").then((res3)=>{
 ...
 const SaveData =()=>
 {
  ...
  const fd=new FormData();
   ...
   if(pictures.length ===0 )
   {
    ...
    Axios.post("https://carpages-canada-mongodb-jnh0.onrender.com/listings/insert_listing", fd ).then((res) =>{
        console.log(res.data );
