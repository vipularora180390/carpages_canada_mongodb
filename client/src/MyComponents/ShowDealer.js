...
export default function ShowDealer() {
  ...
  const [UserDeleteId , setUserDeleteId]= useState('');
   ...
   // console.log("001"+state.dealer_Location_state);
    ...
    useEffect(()=>{
      ...
      if(state)
      {
        ...
        if(state.showDeal)
        {
          Axios.post("https://carpages-canada-mongodb-jnh0.onrender.com/users/search_bar",{keyword:state.showDeal,location:keywordLocation["SearchBarLocation"]}).then((res)=>{
        ...
        {
          Axios.post("https://carpages-canada-mongodb-jnh0.onrender.com/users/getDealerByAlphabet",{alphabet:state.dealer_alphabet}).then((res)=>{
            console.log(res.data);
            setshowDealerList(res.data);
            });
        }
      ...
      else if(!state)
      {
        ...
        Axios.get("https://carpages-canada-mongodb-jnh0.onrender.com/users/allUsers").then((res)=>{
            console.log(res.data);
            setshowDealerList(res.data);
            });
      }
     ...
     if(LocName==="")
      ...
      if(type)
      {
        Axios.post("https://carpages-canada-mongodb-jnh0.onrender.com/users/getDealerByType",{userType:type}).then((res)=>{
            console.log(res.data);
            setshowDealerList(res.data);
            });
    ...
    const changeUserStatus=(ID,status)=>
   {
     ...
     if(status==="unblock")
     {
       Axios.post("https://carpages-canada-mongodb-jnh0.onrender.com/users/updatetUserStatus",{UserId:ID,status:"block"}).then ((response1) =>{
     ...
     {
       Axios.post("https://carpages-canada-mongodb-jnh0.onrender.com/users/updatetUserStatus",{UserId:ID,status:"unblock"}).then ((response1) =>{
         console.log(response1.data);
    ...
    const DealersData=()=>
    {
        ...
        console.log(a+'....'+b+"..."+c+"..."+d+"..."+f+"....");
            if(LocName ==="")
            {
                Axios.post("https://carpages-canada-mongodb-jnh0.onrender.com/users/allDealers",{dealer:"dealer"}).then((res1)=>{
            ...
            else if(LocName.length>0)
            {
                if(a>0)
                {
                    Axios.post("https://carpages-canada-mongodb-jnh0.onrender.com/users/dealerbycity",{city_name:LocName}).then((res1)=>{
                    console.log(res1.data);
                    setshowDealerList(res1.data);
                    });
                }
                else if(a<0)
                {
                    ...
                    Axios.post("https://carpages-canada-mongodb-jnh0.onrender.com/users/dealerbyprovince",{province:LocName}).then((res1)=>{
                    console.log(res1.data);
                    setshowDealerList(res1.data);
                    });
                }
   ...
   if(a>0)
   {
    Axios.post("https://carpages-canada-mongodb-jnh0.onrender.com/users/dealerbycity",{cityname:e}).then((res1)=>{
      console.log(res1.data);
      setshowDealerList(res1.data);
    });
   }
   else if(a<0)
   {
    ...
    Axios.post("https://carpages-canada-mongodb-jnh0.onrender.com/users/dealerbyprovince",{province:e}).then((res1)=>{
      console.log(res1.data);
      setshowDealerList(res1.data);
    });
   }
  ...
  const refineSearch=()=>
  {
     ...
     {  
      ...
      {
        //alert("if 1"+query1);
       Axios.post("https://carpages-canada-mongodb-jnh0.onrender.com/users/getDealerByCity",{city_name:query1,dealer_name:query2}).then((res1)=>{
         console.log(res1.data);
         setshowDealerList(res1.data);
       });
      }
      else if(a<0  && query2.length>0)
      {
       ...
       Axios.post("https://carpages-canada-mongodb-jnh0.onrender.com/users/getDealerByProvince",{province:query1,dealer_name:query2}).then((res1)=>{
         console.log(res1.data);
         setshowDealerList(res1.data);
       });
      }}
      ...
      {
        //alert("else if 2"+query1);
        Axios.post("https://carpages-canada-mongodb-jnh0.onrender.com/users/getDealerByOnlyName",{dealer_name:query2}).then((res1)=>{
          console.log(res1.data);
          setshowDealerList(res1.data);
        });
      }  
