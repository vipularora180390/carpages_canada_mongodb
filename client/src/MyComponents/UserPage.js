...
export default function UserPage() {
  ...
  Axios.get("https://carpages-canada-mongodb-jnh0.onrender.com/users/isUserAuthenticated",{headers:{"x-access-token":Item["token"]},}).then((res)=>{
     ...
     Axios.post("https://carpages-canada-mongodb-jnh0.onrender.com/users/getDealerDetails",{userId:Item["userId"]}).then((res)=>{
      console.log(res.data);
      setuserData(res.data);
     });

  Axios.get("https://carpages-canada-mongodb-jnh0.onrender.com/users/userDeviceInfo").then((res)=>{
    console.log(res.data);
  ...
  Axios.post("https://carpages-canada-mongodb-jnh0.onrender.com/users/InsertuserDeviceInfo",{userId:Item["userId"]}).then((res)=>{
    console.log(res.data);
  });
  GetuserDeviceInfo();
...
const getMyListings=()=>
{
  Axios.post("https://carpages-canada-mongodb-jnh0.onrender.com/listings/getUserListings",{userId:userId}).then((res)=>{
    console.log(res.data);
...
{
  Axios.post("https://carpages-canada-mongodb-jnh0.onrender.com/watchlist/getUserWatchList",{userId:userId}).then((res1)=>{
...
const RollID=()=>
{
  ...
  if(IDs.length>0)
  {
    Axios.post("https://carpages-canada-mongodb-jnh0.onrender.com/watchlist/getUserWatchList1",{listings:IDs}).then((res1)=>{
      console.log(res1.data);
...
const RollData=()=>
{
 ...
 const changePass=()=>
 {
  Axios.post("https://carpages-canada-mongodb-jnh0.onrender.com/users/updatePassword",{userId:userOBJID,user_pass:newpassword}).then((res)=>{
      console.log(res.data);
 ...
 const DeleteWatchlist=(e)=>
 {
  ...
  Axios.post("https://carpages-canada-mongodb-jnh0.onrender.com/watchlist/deleteWatchList",{userId:userId,listing_id:e}).then ((response1) =>{
 ...
 const Update_Buy_From_Home=(e)=>
 {
  ...
  if(e===true)
  {
    Axios.post("https://carpages-canada-mongodb-jnh0.onrender.com/users/updatetBuyFromHome",{userId:userOBJID,B_f_M:"yes"}).then ((response1) =>{
      console.log(response1.data);
  ...
  {
    Axios.post("https://carpages-canada-mongodb-jnh0.onrender.com/users/updatetBuyFromHome",{userId:userOBJID,B_f_M:"no"}).then ((response1) =>{
      console.log(response1.data);
...
{
  Item = JSON.parse(localStorage.getItem('dataItems'));
  Axios.post("https://carpages-canada-mongodb-jnh0.onrender.com/users/GetuserDeviceInfo",{userId:Item["userId"]}).then((res)=>{
    console.log(res.data);
...
{
  Axios.post("https://carpages-canada-mongodb-jnh0.onrender.com/users/DeleteuserDeviceInfo",{Id:e}).then((res)=>{
    console.log(res.data);
    GetuserDeviceInfo();
  });
}
